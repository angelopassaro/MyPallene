...
public class Lexer implements java_cup.runtime.Scanner {
  ...
  public java_cup.runtime.Symbol next_token() throws java.io.IOException {
    ...
    */
    ...
    public static class Lexer implements java_cup.runtime.Scanner {
      ...
      /* user code: */
        private StringBuilder string = new StringBuilder();
            ...
            public Symbol generateTokenSym(String name, int type){
                return symbolFactory.newSymbol(name, type, new ComplexSymbolFactory.Location(yyline+1,yycolumn+1 - yylength()),
                                      new ComplexSymbolFactory.Location(yyline+1,yycolumn+1));
                 }

            public Symbol generateTokenSym(String name, int type, Object value){
                return symbolFactory.newSymbol(name, code, new ComplexSymbolFactory.Location(yyline+1, yycolumn+1),
